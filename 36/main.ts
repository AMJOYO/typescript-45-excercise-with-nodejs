...
function make_shirt(size: string,printMessage: string){
    console.log(`you selected size is ${size} size shirt with ${printMessage} print on shirt`)
}

make_shirt("Large","Nothing is impossible")
make_shirt("Medium","what going on...!")
make_shirt("Size","I love Pakistan")